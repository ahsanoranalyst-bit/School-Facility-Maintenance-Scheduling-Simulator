    ...
    <div class="pricing-card basic-card">
        <div>
            ...
            <ul style="color:white; text-align:left; list-style:none; padding:0; font-size:15px; line-height:2.6;">
                <li>✔ Industry Standard Models</li><li>✔ Foundational Resource Planning</li><li>✔ Core Demand Forecasting</li>
                <li>✔ Up to 5 Projects Included</li><li style="color:#bdc3c7;">✖ Full Library Access</li>
            </ul>
        </div>
        <a href="{basic_doc_url}" target="_blank" class="deploy-btn basic-btn">DEPLOY BASIC</a>
    </div>
    """, unsafe_allow_html=True)
...
with p2:
    ...
    <div class="pricing-card premium-card">
        <div>
            ...
            <ul style="color:white; text-align:left; list-style:none; padding:0; font-size:15px; line-height:2.6;">
                <li>✔ Full Profit Maximizer Suite</li><li>✔ Real-time Logistics Sync</li><li>✔ 24/7 Priority Support</li>
                <li>✔ Custom Dashboard </li><li style="color:#ffd700; font-weight:bold;">💎 Unlimited Full Access</li>
            </ul>
        </div>
        <a href="{premium_doc_url}" target="_blank" class="deploy-btn premium-btn">DEPLOY PREMIUM</a>
    </div>
    """, unsafe_allow_html=True)
